...
(function () {
  ...
  class Window_Message extends Window_Base {
    ...
    updatePlacement() {
      ...
      this._goldWindow.y =
        this.y > 0 ? 0 : Graphics$1.boxHeight - this._goldWindow.height;
    }
  ...
  class Scene_Title extends Scene_Base {
    ...
    createForeground() {
      this._gameTitleSprite = new Sprite(
        new Bitmap(Graphics$1.width, Graphics$1.height)
      );
  ...
  class Game_BattlerBase {
    ...
    traitsPi(code, id) {
      return this.traitsWithId(code, id).reduce((r, { value }) => r * value, 1);
    }

    traitsSum(code, id) {
      return this.traitsWithId(code, id).reduce((r, { value }) => r + value, 0);
    }
    ...
    meetsItemConditions(item) {
      return (
        this.meetsUsableItemConditions(item) && self.$gameParty.hasItem(item)
      );
    }
