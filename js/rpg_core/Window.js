...
Window.prototype._createAllParts = function() {
    ...
    this._windowBackSprite = new PIXI.NineSlicePlane(PIXI.Texture.from('img/system/Window_Back.png'), 12, 12, 12, 12);
    this._windowCursorSprite = new PIXI.NineSlicePlane(PIXI.Texture.from('img/system/Window_Cursor.png'), 12, 12, 12, 12);
    this._windowFrameSprite = new PIXI.NineSlicePlane(PIXI.Texture.from('img/system/Window_Frame.png'), 12, 12, 12, 12);
